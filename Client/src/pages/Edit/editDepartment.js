              ...
              <div className="row">
                <div className="col">
                  <div className="form-floating mb-3">
                    ...
                    />
                    <label htmlFor="floatingDob">No. of Faculties</label>
                  </div>
                </div>
                <div className="col"></div>
              </div>
                ...
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      placeholder="Password"
                    />
                    <label htmlFor="floatingDob">First Year Students</label>
                  </div>
                </div>
                <div className="col"></div>
              </div>
                ...
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      placeholder="Password"
                    />
                    <label htmlFor="floatingDob">Second Year Students</label>
                  </div>
                </div>
                <div className="col"></div>
              </div>
                ...
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      placeholder="Password"
                    />
                    <label htmlFor="floatingDob">Third Year Students</label>
                  </div>
                </div>
                <div className="col"></div>
              </div>
                ...
                <div className="col">
                  <div className="form-floating mb-3">
                    <input
                      ...
                      placeholder="Password"
                    />
                    <label htmlFor="floatingDob">Forth Year Students</label>
                  </div>
                </div>
                <div className="col"></div>
              </div>
